const beginButton = document.querySelector('#meditate-button');
const preScreen = document.querySelector('.container');
const meditationSession = document.querySelector('.meditation-session');


beginButton.addEventListener('click',()=>{
    preScreen.style.display= 'none';
    meditationSession.style.display='flex';
});
...
(function() {
    ...
    function lotusAdd() {
        lotus.classList.add('pulse');
    }

    timeButton.addEventListener("click",()=>{
        setTimeout(lotusAdd(), 5000); 
    })
